...
int assesmentLevel, engineerCount = 0;
char choice[3];
...
cout <<  "Fill in the empty fields mentioned below, when you have entered all the fields, select Q)uit" << endl;
 ...
 do {
    ...
    case 'A': 
        ...
        cout << "Pick engineer title level by selecting(a-h): " << endl << endl;
       ...
       // theEngineerList.getEngineerTitleChoice(choice);

switch (choice[0]) {

        case 'a': engineerTitle = L1; break;
        case 'b': engineerTitle = L2; break;
        case 'c': engineerTitle = L3; break;
        case 'd': engineerTitle = L4; break;
        case 'e': engineerTitle = L5; break;
        case 'f': engineerTitle = L6; break;
        case 'g': engineerTitle = L7; break;
        case 'h': engineerTitle = L8; break;
        default:
...
anEngineer.setEngineer(lastName, firstName, engineerTitle, assesmentLevel, engineerCount);

// insert the created engineer so it appears in the list
engineerList.insert(anEngineer);

engineerList.printMission();
